    ...
    function ResourceEvents(props) {
        ...
        _this.initDrag = function (ev) {
            ...
            if (viewType !== 1) {
                ...
                var currentX = ev.clientX - pos.x; //ev.clientY - pos.y
                 ...
                 _this.getBrowserId() === 3 ? startY = startY + scroll : undefined
                 var topIndex =  Math.floor(startY / 14.6)
                 var top = (topIndex * 14.6)
                 var bottomIndex = Math.ceil(startY / 14.6);
                 var height = (bottomIndex - topIndex) * 14.6
        ...
        _this.doDrag = function (ev) {
            ...
            if (viewType !== 1) {
                ...
                var topIndex = Math.floor(Math.min(startY, currentY) / 14.6); // startX, CurrentX /8
                topIndex = topIndex < 0 ? 0 : topIndex; 
                var top = (topIndex * 14.6); //8.8
                var bottomIndex = Math.ceil(Math.max(startY, currentY) / 14.6);
                ...
                if (headerItem.count > 0 || headerItem.summary != undefined) {
                    ...
                    headerItem.events.forEach(function (evt, idx) {
                        if (idx < renderEventsMaxIndex && evt !== undefined && evt.render) {
                            ...
                            var top2 = (eventStart.format('H')-6) * 14.6
